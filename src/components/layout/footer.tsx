				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
					...
					<div className="flex flex-col gap-6">
						...
						<ul className="flex flex-col gap-4">
							<li><a href="#coming-soon" className="text-white/40 hover:text-white text-sm transition-colors">App</a></li>
							<li><a href="#coming-soon" className="text-white/40 hover:text-white text-sm transition-colors">Stake</a></li>
							<li><a href="#coming-soon" className="text-white/40 hover:text-white text-sm transition-colors">Borrow</a></li>
						</ul>
					</div>
